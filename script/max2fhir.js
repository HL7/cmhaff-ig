...
var satisfiedBy = {};
if (fs.existsSync("satisfiedBy.txt")) {
...
var template_filename = "cmhaff-ig-template.json";
...
function sort(obj) {
    ...
    var section_sortkey = [];
    // CMHAFF chapters
    section_sortkey['PDS'] = '1PDS';
    section_sortkey['PIM'] = '2PIM';
    section_sortkey['APU'] = '3APU';
    section_sortkey['AST'] = '4AST';
    section_sortkey['PUD'] = '5PUD';
    section_sortkey['CNA'] = '6CNA';
